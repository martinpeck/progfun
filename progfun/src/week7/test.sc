...
object test {
  val problem = new Pouring(Vector(4, 9, 19))     //> problem  : week7.Pouring = week7.Pouring@2adb1d4
  ...
  problem.solutions(17)                           //> res1: Stream[week7.test.problem.Path] = Stream(Fill(1) Fill(0) Pour(0,2) Pou
